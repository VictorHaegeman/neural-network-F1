...
REQUIRED_NONEMPTY_FILES = [
    ...
    "outputs/predictions/race_model_renders/race_model_rankings_2025.csv",
    "outputs/predictions/race_model_renders/race_model_summary_2025.csv",
    "outputs/predictions/race_model_renders/race_model_notes_2025.json",
    ...
    "outputs/figures/predictions/model_hit_heatmap.png",
    "outputs/figures/predictions/model_points_captured.png",
    "outputs/figures/predictions/model_precision_by_race.png",
    "outputs/figures/predictions/race_overviews/2025_08_monaco_grand_prix.png",
    "outputs/figures/predictions/race_cards/2025_08_monaco_grand_prix.png",
    "outputs/figures/showcase/completed_results/2025_08_monaco_grand_prix_card.png",
    "outputs/figures/showcase/upcoming_forecasts/2026_05_forecast_card.png",
...
REQUIRED_SCRIPTS = [
    ...
    "scripts/generate_prediction_renders.py",
    "scripts/generate_showcase_images.py",
