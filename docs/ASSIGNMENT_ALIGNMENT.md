...
| Categorical and numeric data | Satisfied | 179 numeric/bool columns and 22 categorical/text columns |
| More than 12 variables | Satisfied | 201 final columns |
...
| Cover details | Satisfied | Cover includes group member names, TP numbers, class/intake code, hand-out date, hand-in date and weightage |
...
| Analysis and recommendations | Satisfied | Report compares models and recommends the random forest classifier |
...
2. Main models: random forest, histogram gradient boosting, extra trees and logistic regression.
